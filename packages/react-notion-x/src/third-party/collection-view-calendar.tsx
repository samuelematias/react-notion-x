            ...
            <div className='notion-calendar-body'>
                {weeksArr.map((i, indexI) => (
                    <div
                        ...
                        style={{
                            height: `${checkWeek(indexI) == 0 ? 143.99 : checkWeek(indexI) * 110 + 34
                                }px`
                        }}
                        key={indexI}
                    >
                                    ...
                                    if (
                                        ...
                                        return (
                                            <div
                                                ...
                                                style={{
                                                    left: `calc(${dayBlock == 0 ? 0 : dayBlock * 14.2857
                                                        }%)`,
                                                    height: `${collectionView.format?.calendar_properties &&
                                                        Object.keys(
                                                    ...
                                                    top: `${(checkWeek(indexI) != 0 ? sum * 110 : 0) + 30
                                                        }px`
                                                }}
                                                key={block.id}
                                            >
